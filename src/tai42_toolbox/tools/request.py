...
:mod:`tai42_toolbox._internal.tools.http_client`; this entrypoint is thin.

The curl client lives in tai42-kit behind its ``curl`` extra; this tool's backing
dependency is opt-in as ``pip install 'tai42-toolbox[http]'``. Missing it raises a
